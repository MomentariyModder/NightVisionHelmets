...
public abstract class GoldNightItem extends ArmorItem {
	public GoldNightItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends GoldNightItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "night_vision_helmets:textures/models/armor/gold_layer_1.png";
		}
