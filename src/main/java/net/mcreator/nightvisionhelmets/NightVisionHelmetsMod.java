...
@Mod("night_vision_helmets")
public class NightVisionHelmetsMod {
	public static final Logger LOGGER = LogManager.getLogger(NightVisionHelmetsMod.class);
	...
	public NightVisionHelmetsMod() {
		NightVisionHelmetsModTabs.load();
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		NightVisionHelmetsModItems.REGISTRY.register(bus);
